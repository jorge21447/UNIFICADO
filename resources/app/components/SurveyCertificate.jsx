...
const SurveyCertificate = ({ surveys }) => {
              ...
              <div className="flex-1 flex items-center space-x-2">
                <h2 className="text-2xl font-semibold ">
                  <span className="text-gray-800 dark:text-gray-100">
                    Lista de Encuestas - Certificados
                  </span>
                </h2>
              </div>
            </div>
                    ...
                    results.map((elm) => (
                      ...
                      >
                        ...
                        <td className="px-4 py-3 text-center">
                          ...
                          {elm?.responses?.length > 0 ? Math.ceil(elm?.responses?.length / elm?.sections[0]?.questions?.length) :0}
                          </span>
                        </td>
                        ...
                        <td className="px-4 py-3  font-medium text-gray-900 whitespace-nowrap dark:text-white">
                          ...
                          bg-indigo-600 rounded-lg hover:bg-indigo-700 focus:ring-4 focus:outline-none focus:ring-indigo-300 dark:bg-indigo-600 dark:hover:bg-indigo-600 dark:focus:ring-indigo-700"
                              onClick={() => {
                                navigate(`/${roles[userSurvey.role.name]}/certificates/${elm.id}`);
                              }}
                            >
                              <FaUsers />
                              {/* Editar */}
